...
/// Create a fresh Coincube database with the given schema.
...
// In Coincube 0.4 we upgraded the schema to hold a timestamp for transaction drafts. Existing
...
// After Coincube 1.0 we upgraded the schema to record whether a coin originated from an immature
...
// After Coincube 1.1 we upgraded the schema to add the labels table.
