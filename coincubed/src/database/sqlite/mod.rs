...
mod tests {
    ...
    // The database schema used by the first versions of Coincube (database version 0). Used to test
...
";
    ...
    fn dummy_db() -> (
        ...
        let db_path: path::PathBuf = [tmp_dir.as_path(), path::Path::new("coincubed.sqlite3")]
            .iter()
            .collect();
