...
use iced::{
    ...
    widget::{
        button::{Status, Style},
        column, container, pick_list, row, Button, Column, Space,
    },
...
use liana_ui::{
    ...
    component::{
        button, card, form,
        hw::Account,
        text::{h3, p1_bold, p1_regular},
        tooltip,
    },
    icon,
    theme::{self, Theme},
    widget::{Container, Element, Row},
};
...
impl SelectKeySource {
    ...
    fn widget_generate_hot_key(&self) -> Element<Message> {
        let row = row![
            ...
            tooltip("We recommend to use this option only for test purposes")
        ]
        .height(BTN_H)
        .spacing(10)
        .align_y(Vertical::Center);
