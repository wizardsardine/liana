...
impl Step for SelectRecoveryPath {
    fn load(&mut self, cache: &Cache, _draft: &TransactionDraft, _recovery_timelock: Option<u16>) {
        ...
        self.recovery_paths = recovery_paths(&self.wallet, &cache.coins, cache.blockheight);
