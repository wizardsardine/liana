    ...
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::ListTransaction(e) => match e {
                ListTransactionError::Daemon(e) => write!(f, "Fail to list transactions: {}", e),
                ListTransactionError::TxTimeMissing => write!(f, "Fail to list transactions: Transaction timestamp missing"),
            }
        }
    }
}
