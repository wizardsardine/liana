...
fn pill_styles() -> Sample<11> {
    [
        ...
        (pill_sample("L",            XL, theme::pill::simple),       "liana_ui::component::pill::PillWidth::L"),
        (pill_sample("simple",       M, theme::pill::simple),       "liana_ui::theme::pill::simple"),
        (pill_sample("simple_fill",       M, theme::pill::simple_fill),       "liana_ui::theme::pill::simple_fill"),
