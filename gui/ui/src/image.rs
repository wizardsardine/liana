...
const LIANALITE_BRAND_GREY: &[u8] = include_bytes!("../static/logos/logo-liana-lite.svg");
...
pub fn lianalite_brand_grey() -> Svg {
    let h = Handle::from_memory(LIANALITE_BRAND_GREY.to_vec());
    Svg::new(h)
}
