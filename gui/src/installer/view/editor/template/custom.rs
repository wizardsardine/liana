...
pub fn custom_template_primary(
    ...
    layout(
        ...
        Column::new()
            .align_items(Alignment::Start)
            .max_width(1000.0)
            .push(p1_regular(prompt::DEFINE_DESCRIPTOR_PRIMARY_PATH_TOOLTIP).style(color::GREY_3))
                    ...
                    button::primary(None, "Continue")
                        ...
                        .on_press_maybe(if valid {
                            Some(Message::DefineDescriptor(
                                message::DefineDescriptor::TemplatePage(1),
                            ))
                        } else {
                            None
                        }),
...
pub fn custom_template_recovery<'a>(
    progress: (usize, usize),
    use_taproot: bool,
    ...
    layout(
        ...
        Column::new()
            .align_items(Alignment::Start)
            .max_width(1000.0)
            .push(p1_regular(prompt::DEFINE_DESCRIPTOR_RECOVERY_PATH_TOOLTIP).style(color::GREY_3))
        ...
        true,
        Some(Message::DefineDescriptor(
            message::DefineDescriptor::TemplatePage(0),
        )),
    )
}
