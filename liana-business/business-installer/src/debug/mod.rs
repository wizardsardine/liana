...
use liana_connect::ws_business::{
    Key, KeyIdentity, KeyType, Org, SecondaryPath, SpendingPath, Timelock, User, UserRole, Wallet,
    WalletStatus,
};
use liana_gui::{
...
fn seed_test_data(app: &mut AppState) {
    ...
    app.primary_path = SpendingPath::new(true, 2, vec![0, 1]);
    app.secondary_paths = vec![
        SecondaryPath {
