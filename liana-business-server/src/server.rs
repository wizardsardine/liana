...
use liana_connect::ws_business::{Response, UserRole};
...
impl Server {
    ...
    pub fn print_tokens(&self) {
        ...
        sorted_users.sort_by(|a, b| {
            ...
            let role_order = |r: &UserRole| match r {
                UserRole::WizardSardineAdmin => 0,
                UserRole::WalletManager => 1,
        ...
        for user in sorted_users {
            let role_str = match user.role {
                ...
                UserRole::WalletManager => "WalletMgr  ",
    ...
    pub fn run(&mut self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        let state_clone = ServerState {
            ...
            registration_infos: Arc::clone(&self.state.registration_infos),
        };
                ...
                match stream {
                    Ok(mut stream) => {
                        ...
                        let state_clone = ServerState {
                            ...
                            registration_infos: Arc::clone(&http_state.registration_infos),
                        };
